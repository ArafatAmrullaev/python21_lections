...
# 1. Проблема ромба = решённая проблема: начиная с версии 2.3 (с помощью MRO - method resolution order)
...
# 2. Проблема перекрестного наследования - нерешённая проблема
